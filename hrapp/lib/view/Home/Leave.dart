...
class _LeaveState extends State<Leave> {
  ...
  final List<Widget> _contentWidgets = [
    Text('Review Section: Here you can see the pending leave requests.', style: TextStyle(fontSize: 18)),
    Text('Accepted Section: Here you can see the leave requests that were accepted.', style: TextStyle(fontSize: 18)),
    Text('Denied Section: Here you can see the leave requests that were denied.', style: TextStyle(fontSize: 18)),
  ];
                          ...
                          children: [
                            Row(
                              children: [
                                ...
                                Text("Leaves Used", style: TextStyle(fontSize: 20))
                              ],
                            ),
  ...
  Widget _buildButton(String title, int index) {
    return ElevatedButton(
      style: ElevatedButton.styleFrom(
        ...
        backgroundColor: _selectedIndex == index ? Colors.purple : Colors.grey[300],
